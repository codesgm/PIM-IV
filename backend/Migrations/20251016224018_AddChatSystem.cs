        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserContact = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    InitialMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chats_Usuarios_AssignedTechnicianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chats_AssignedTechnicianId",
                table: "Chats",
